...
import nav from '../../public/navigation.png';
import mail from '../../public/mail.png';
import calen from '../../public/calendar.png';
...
export default function Home() {
  ...
  function handleBack() {
    return currentIndex != 0 ? setIndex(currentIndex - 1) : setIndex(equipment.length - 1)
  }
  function handleNext() {
    return currentIndex != equipment.length - 1 ? setIndex(currentIndex + 1) : setIndex(0)
  }
  return (
    <div>
        ...
        <div className={style.equipmentWrapper}>
          ...
          <div className={style.wrapper}>
            <div className={style.wr}>
              <Image onClick={handleBack} src={but} alt="img" className={`${style.block} ${style.left}`} />
            </div>
            ...
            <div className={style.wr}>
              <Image onClick={handleNext} src={but} alt="img" className={`${style.block} ${style.right}`} />
            </div>
          </div>
          <p className={style.showAll}>показать все</p>
        </div>
      ...
      <section className={style.contacts}>
        ...
        <Image src={map} alt='map' className={style.image}></Image>
        <div className={style.contactsWrapper}>
          <div className={style.block}>
            <Image src={smartphone} alt='icon'></Image>
            <p>+7 (495) 055-75-86
            </p>
          </div>
          <div className={style.block}>
            <Image src={nav} alt='icon'></Image>
            <p>г. Москва, ул. Доватора, 7/8 с1
            </p>
          </div>
          <div className={style.block}>
            <Image src={mail} alt='icon'></Image>
            <p>order@world-bike.ru
            </p>
          </div>
          <div className={style.block}>
            <Image src={calen} alt='icon'></Image>
            <p>Без выходных 10:00-20:00
            </p>
          </div>
